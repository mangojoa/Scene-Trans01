...
class ViewController: UIViewController {
    ...
    @IBAction func moveNext(_ sender: Any) {
        ...
        /* [22.07.05]
         ...
         스크린에 새로 표시할 뷰 컨트롤러를 스토리보드로 부터 읽어와 인스턴스화 하는 부분이다.
         ...
         여기서 문제가 될 수 있는 것이 있다. 이는 매우 중요한 부분이며 실전에서 사용되고 있는 기법이다.
         만약 새롭게 생성한 스토리보드가 N개라면? (1 < N)
         기능이나 성격에 따라 화면을 분리하다 보면 때에 따라 스토리보드 파일이 여러개 존재할 수 밖에 없다.
